...
namespace ConsoleApp_ADS
{
    ...
    public class SimpleTree<T>
    {
        ...
        public List<SimpleTreeNode<T>> GetAllNodes()
        {
            ...
            StartGetAllNodes(Root, ref result);
            return result;
        }
        private static void StartGetAllNodes(SimpleTreeNode<T> root, ref List<SimpleTreeNode<T>> result)
        {
            foreach (var child in root.Children)
            {
                result.Add(child);
                StartGetAllNodes(child, ref result);
            }
            return;
        }
